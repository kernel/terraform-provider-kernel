...
- `protocol` (String) Proxy protocol as reported by the API, e.g. `http` or `https`.
- `type` (String) Proxy type as reported by the API, e.g. `datacenter`, `isp`, `residential`, `mobile`, or `custom`.
