		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("data.kernel_proxy.by_id", "username"),
					resource.TestCheckNoResourceAttr("data.kernel_proxy.by_id", "password"),
					resource.TestCheckNoResourceAttr("data.kernel_proxy.by_id", "status"),
					resource.TestCheckNoResourceAttr("data.kernel_proxy.by_id", "ip_address"),
					...
					resource.TestCheckNoResourceAttr("data.kernel_proxy.by_name", "username"),
					resource.TestCheckNoResourceAttr("data.kernel_proxy.by_name", "password"),
					resource.TestCheckNoResourceAttr("data.kernel_proxy.by_name", "status"),
					resource.TestCheckNoResourceAttr("data.kernel_proxy.by_name", "ip_address"),
				),
			},
			{
				Config:   config,
...
func testAccCreateProxyFixture(t *testing.T, projectID, name string) string {
	...
	acctest.CleanupProxy(t, projectID, proxy.ID)
